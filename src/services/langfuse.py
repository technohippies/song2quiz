...
def register_models():
    ...
    try:
        ...
        client.post("/api/public/models", json={
            ...
            "input_price": MODEL_COSTS["nvidia/llama-3.1-nemotron-70b-instruct"]["input_cost"],
            "output_price": MODEL_COSTS["nvidia/llama-3.1-nemotron-70b-instruct"]["output_cost"],
            "unit": "TOKENS",
            "tokenizer": {
                "type": "openai",
                "model": "gpt-3.5-turbo",
