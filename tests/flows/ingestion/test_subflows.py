...
from src.utils.io.paths import get_songs_catalog_path, get_song_dir
...
def test_song_ingestion_flow(tmp_path, mock_genius_response, mock_lyrics_response, mock_annotations):
    ...
    with patch('src.services.genius.GeniusAPI') as MockGenius, \
         patch('src.services.lrclib.LRCLibAPI') as MockLRCLib:
        ...
        lrclib_instance = MockLRCLib.return_value
        lrclib_instance.search_lyrics.return_value = mock_lyrics_response
